...
public class PersonalLoanRule {

    private static final float ADDITINAL_RATE = 0.2f;
    private Integer FIVE_LACS=500000;
    private Integer TWENTY_LACS=2000000;
    ...
    private boolean amountCheck(RuleDTO ruleDTO) {
        return ruleDTO.getPrincipleAmount()>FIVE_LACS && ruleDTO.getPrincipleAmount() < TWENTY_LACS;
    }
}
